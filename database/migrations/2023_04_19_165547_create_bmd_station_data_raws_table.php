...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bmd_station_data_raws', function (Blueprint $table) {
            ...
            $table->float("maximum_temp", 8, 1)->nullable();
            $table->float("minimum_temp", 8, 1)->nullable();
            $table->float("dry_bulb", 8, 1)->nullable();
            $table->float("humidity" ,8, 1)->nullable();
            $table->float("rainfall", 8, 1)->nullable();
            $table->float("rainfall_3", 8, 1)->nullable();
            $table->float("rainfall_6", 8, 1)->nullable();
            $table->float("rainfall_24", 8, 1)->nullable();
